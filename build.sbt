...
libraryDependencies += "org.apache.spark" %% "spark-core" % "1.5.0" % "provided" withSources()
libraryDependencies += "org.apache.spark" %% "spark-mllib" % "1.5.0" % "provided" withSources()
libraryDependencies += "com.databricks" %% "spark-csv" % "1.4.0"
libraryDependencies += "org.json4s" %% "json4s-native" % "3.3.0"
libraryDependencies += "saurfang" % "spark-knn" % "0.1.0"
libraryDependencies += "com.github.scopt" %% "scopt" % "3.4.0"
libraryDependencies += "org.scalactic" %% "scalactic" % "2.2.6"
libraryDependencies += "org.scalatest" %% "scalatest" % "2.2.6" % "test"
libraryDependencies += "com.holdenkarau" %% "spark-testing-base" % "1.5.0_0.3.1" excludeAll(ExclusionRule(organization = "org.scalatest"))
